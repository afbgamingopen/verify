    ...
    <div class="row-wrap svelte-1j9612g">
      ...
      <div class="scrollX kenoResult">
        ...
        <span
          class="weight-semibold line-height-default align-left size-medium text-size-medium variant-highlighted with-icon-space svelte-1myjzud"
          style="font-family: monospace"
          >({{ data.kenoFinalResult.join(", ") }})</span
        >
      </div>
    </div>
    <div class="row-wrap svelte-1j9612g">
    ...
    <div class="row-wrap svelte-1j9612g">
      ...
      <div class="wrap scrollX" style="display: flex; flex-direction: row">
        <table>
          <tbody>
            <tr
              v-for="(nums, rowIndex) in data.kenoNumberToShuffle"
              :key="rowIndex"
              class="tr svelte-1lfzokq"
            >
              <td
                v-for="(num, colIndex) in nums"
                :key="colIndex"
...
em.variant-highlighted.svelte-1myjzud,
span.variant-highlighted.svelte-1myjzud,
h1.variant-highlighted.svelte-1myjzud,
h2.variant-highlighted.svelte-1myjzud,
h3.variant-highlighted.svelte-1myjzud,
h4.variant-highlighted.svelte-1myjzud,
h5.variant-highlighted.svelte-1myjzud,
h6.variant-highlighted.svelte-1myjzud,
p.variant-highlighted.svelte-1myjzud {
