...
function calc() {
  ...
  calced.resultPow =
    bytes[0 + props.byteIndex] / Math.pow(256, 1) +
...
<template>
  <div class="column">
    <span class="highlight" style="font-family: monospace; white-space: nowrap">
      ({{ calced.digestBytes[props.byteIndex + 0] }},
      {{ calced.digestBytes[props.byteIndex + 1] }},
      {{ calced.digestBytes[props.byteIndex + 2] }},
      {{ calced.digestBytes[props.byteIndex + 3] }}) -&gt; [0, ...,
      {{ props.maxRange - 1 }}] =
      {{ (calced.finalResult * 100).toFixed(0) }}</span
    >
    <table>
      <tbody>
        <tr>
          ...
          <td class="td" style="text-align: left; padding: 0">
            ...
            >
              {{
                (calced.digestBytes[props.byteIndex + 0] / Math.pow(256, 1))
                  .toFixed(12)
                  .substring(1, 14)
              }}</span
            >
        ...
        <tr>
          ...
          <td class="td" style="text-align: left; padding: 0">
            ...
            >
              {{
                (calced.digestBytes[props.byteIndex + 1] / Math.pow(256, 2))
                  .toFixed(12)
                  .substring(1, 14)
              }}</span
            >
        ...
        <tr>
          ...
          <td class="td" style="text-align: left; padding: 0">
            ...
            >
              {{
                (calced.digestBytes[props.byteIndex + 2] / Math.pow(256, 3))
                  .toFixed(12)
                  .substring(1, 14)
              }}</span
            >
        ...
        <tr>
          ...
          <td class="td" style="text-align: left; padding: 0">
            ...
            >
              {{
                (calced.digestBytes[props.byteIndex + 3] / Math.pow(256, 4))
                  .toFixed(12)
                  .substring(1, 14)
              }}</span
            >
          ...
          <td class="td">
            <span style="font-family: monospace; white-space: nowrap">
              ({{
                calced.digestBytes[props.byteIndex + 3]
                  .toString()
                  .padStart(3, "0")
              }}
              / (256 ^ 4))</span
        ...
        <tr>
          ...
          <td class="td" style="text-align: left; padding: 0">
            <span
              ...
              style="font-family: monospace; white-space: nowrap"
            >
              {{ calced.resultPow.toFixed(12).substring(1, 14) }}</span
            >
          </td>
